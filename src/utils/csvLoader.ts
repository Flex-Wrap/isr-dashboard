...
export const CSV_COLUMNS = {
  ...
  REGION: 'Please confirm your region, based on the Council\u2019s regional classification.',
...
export async function loadCSV(filePath: string, filterColumns?: string[]): Promise<any[]> {
